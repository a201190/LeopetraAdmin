    ...
    render(){
        return(
            <Form>
               ...
               <FormGroup>
                   <Row>
                       <Col md="3"><p>Event Description:</p></Col>
                       <Col md="9">
               ...
               <FormGroup>
                    <Row>
                       <Col md="3"><p>End Date Time:</p></Col>
                       <Col md="9">
                            <Input type="text" className="Allinput"/>
                       </Col>
                   </Row>
               ...
               <FormGroup>
                    <Row>
                       <Col md="3"><p>Contact Person:</p></Col>
                       <Col md="9">
                            <Input type="text" className="Allinput"/>
                       </Col>
                    </Row>                                    
